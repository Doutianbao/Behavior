function varargout = GetTailTangents(tailCurv,varargin)
...
%   al., 2013
% tailAngles = GetTailTangents(tailCurv,nAngles);
% [tailAngles,headAngles] = GetTailTangents(tailCurv,nAngle,dS);
%
% Inputs:
...
% dS - distances between successive pts on the tail (returned by
%   GetMidlinesByThinning). If dS is included, then tailAngles for any given 
%   time point t is normalized by the length of dS
%   for 
%
