...
%     {'bodyAmp','headAmp'});
[~, procData] = GetFishWaves_group(paths(1), 'saveToProc',1,'xLim',xLim_tap,...
...
[~, procData] = GetFishWaves_group(paths(1), 'saveToProc',1,'xLim',xLim_dark,...
    'onsetAlign',onsetAlign,'sigmaXY',sigmaXY,'plotOrNot',plotOrNot,'cLim',cLim,'freqRange',freqRange_dark);
